...
private static Scanner input = new Scanner(System.in);
   public static void Ending(){
      Output.type("There is still hope for me,I could use one man rocket pod to return to earth" + 
   ...
   public static void scene1(){
     ...
     "\n If the computer is still intact It’ll tell me exactly what state the rocket is in. There are two ways to get there."+
   ...
   "\n OH GOD ! a huge explosion just went off, I don’ t think i'm going to ma.....  Tyler ran out of time and died ");
   System.out.println();
   ...
   public static void scene5a(){
      ...
      "hmmm okay send 50 % fuel to the rocket, I just know that is the right amount.","Hmmm okay send 30% fuel to the rocket, I just know that is  the right amount.");
       boolean validInput = false;
        while (!validInput) {
            System.out.print("\nEnter choice: ");
            switch (input.nextInt()) {
