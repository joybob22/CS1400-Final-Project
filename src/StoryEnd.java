...
public class StoryEnd {
    ...
    public static void scene1() {
        System.out.println();
        Output.type(
                "Okay to reach the rocket I would need to get to the western part of the base and reach Pod A where the central diagnostic computer is."
    ...
    public static void scene4() {
        ...
        System.out.println();
        Output.choices(
                "Just keep heading to Pod A, you don't have time to go other pods,and like you said the rocket is probably fueled",
    ...
    public static void scene5() {
        ...
        System.out.println();
        Output.type(
                " you're right, this base could blow up again at any moment I don't have time to waste, I'm heading straight to Pod A."
        ...
        System.out.println();
        Output.choices(
                "you have to take the risk and just get in the rocket and get the hell out of there,you dont have time to make it back.",
    ...
    public static void scene5a() {
        System.out.println();
        Output.type(
                "good idea, i'll head to pod C really quickly and send fuel to the rocket in case the rocket needs it..");
        Output.delayMilliseconds(700);
        Output.delayWithDots(30);
        ...
        System.out.println();
        Output.choices(
                "Don't take the risk, just head to pod A immediately and get out of there. The base could blow up at any moment.",
                "okay send 50 % fuel to the rocket, I just know that is the right amount.",
                "okay send 30% fuel to the rocket, I just know that is the right amount.");
        boolean validInput = false;
        while (!validInput) {
            System.out.print("\nEnter choice: ");
            switch (input.nextInt()) {
    ...
    public static void scene6c() {
        ...
        Output.type("\n okay I see the central computer...."
                ...
                + "\n I cant believe this, all systems are still intact, it mustve survived the blast because it was in the underground silo at the time of explosion."
                + "\n Okay time to set the coordinates to earth and get out of here. "
                ...
                + "\n Thank you so much for your help, without you there is no way  I couldve made it back home !"
    ...
    public static void scene6a() {
        Output.type(
                "you're right, this base could blow up again at any moment I dont have time to waste, I'm heading straight to Pod A."
                        + "\n Okay I see the pod entrance..." + "\n I'm in, the computer should be here...."
                        + "\n I found it ! and it's intact, this is a miracle ! Okay let's see what kind of condition the rocket is in."
                        + "\n I cant believe this, all systems are still intact, it mustve survived the blast because it was in the underground silo at the time of explosion."
    ...
    public static void scene1a() {
        System.out.println();
        Output.type(
                "I think you're right, the rocket could be useless for all I know. In that case I'll need to find the Rover and get it running."
        ...
        System.out.println();
        Output.choices(
                "Take the longer the route, it's safer. If you scout the area you're not guaranteed to find a quicker route and the other route could be dangerous.",
    ...
    public static void scene2a() {
        ...
        Output.type("Good idea, let me scout the outdoor terrain and see if there is a quicker way to the Pod."
                ...
                + "\n  I'm not going to make it, I shouldve never listened to you"
    ...
    public static void scene2() {
        System.out.println();
        Output.type("okay I'll take the route I already know its longer but safer..."
                ...
                + "\n thatll tell me the fuel level and if everything is working fine. "
                + "\n Im not sure because this base can blow up at any moment and I already took an hour to get here. What should I do ?");
        System.out.println();

        Output.choices(
                "Yes do a check, you might need to make sure it has enough fuel, if you run out of fuel on the way youre dead.",
                "No! Get the hell out of there, you dont time to do that. Get in that Rover and start heading to the other base NOW!");
        boolean validInput = false;
        while (!validInput) {
            System.out.print("\nEnter choice: ");
            switch (input.nextInt()) {
    ...
    public static void scene3() {
        System.out.println();
        Output.type(
                "Good idea I should make sure I have enough fuel, it's risky but the last thing I want is to get stuck in the middle of the Martian desert."
                        ...
                        + "\n I'm heading out Im half way there now, everything is going well.. I see the base now..."
                        + "\n I have safely made it to the base, thank you so much. If it wasnt for you I'd be dead. Tyler makes it to the other base safely and gets help");
    }

    public static void scene3a() {
        System.out.println();
        Output.type(
                " You're right, what am I thinking, this base could blow up at any moment I don't have time to check."
                        + "\n I'm making my way to the other base, the trip should take a hour and half.... "
                        + "\n 20 mins, everything is going fine, I cant believe i made it out of there alive..."
                        + "\n 40 mins in. Oh no, the Rover has slowed down, I don't know what is going on, please god dont let it be running out of fuel... "
